...
* 🚀 FEATURES: · Add action to add new product version ([#10865](https://github.com/hcengineering/platform/issues/10865)) · Ability to skip initial content creation ([#10812](https://github.com/hcengineering/platform/issues/10812)) · Print fixes and improvements ([#10905](https://github.com/hcengineering/platform/issues/10905)) · Add Polish translation ([#10907](https://github.com/hcengineering/platform/issues/10907)) · Add hosting shutdown announcement ([#10930](https://github.com/hcengineering/platform/issues/10930)) · Add backup download button and script ([#10935](https://github.com/hcengineering/platform/issues/10935)) · Add baseType property and related functionality across card models and UI components ([#10940](https://github.com/hcengineering/platform/issues/10940)) · Implement reference versioning functionality across various com… ([#10941](https://github.com/hcengineering/platform/issues/10941)) · Add OnExecutionDone trigger and related functionality for proce… ([#10944](https://github.com/hcengineering/platform/issues/10944)) · Add backup/restore guide ([#10945](https://github.com/hcengineering/platform/issues/10945)) 
* 🐛 BUG FIXES: · Markup check ([#10836](https://github.com/hcengineering/platform/issues/10836)) · Main section lock ([#10837](https://github.com/hcengineering/platform/issues/10837)) · Add missing translation ([#10845](https://github.com/hcengineering/platform/issues/10845)) · Enum presenter readonly ([#10846](https://github.com/hcengineering/platform/issues/10846)) · *(ci)* Emit declarations in tag npm publish ([#10842](https://github.com/hcengineering/platform/issues/10842)) · Product version export ([#10866](https://github.com/hcengineering/platform/issues/10866)) · Tag attribute lock ([#10850](https://github.com/hcengineering/platform/issues/10850)) · Markup field in md table ([#10840](https://github.com/hcengineering/platform/issues/10840)) · Throw Forbidden if user is not workspace member in checkJoin ([#10869](https://github.com/hcengineering/platform/issues/10869)) · Invite workflow ([#10861](https://github.com/hcengineering/platform/issues/10861)) · *(client)* Downgrade slow query diagnostics ([#10884](https://github.com/hcengineering/platform/issues/10884)) · *(notification)* Ignore blank browser push keys ([#10885](https://github.com/hcengineering/platform/issues/10885)) · Slots ([#10898](https://github.com/hcengineering/platform/issues/10898)) · Better public holidays display ([#10901](https://github.com/hcengineering/platform/issues/10901)) · Formatting ([#10911](https://github.com/hcengineering/platform/issues/10911)) · Account info disclosure ([#10874](https://github.com/hcengineering/platform/issues/10874)) · Add tag ([#10921](https://github.com/hcengineering/platform/issues/10921)) · Adjust editor left menu position ([#10928](https://github.com/hcengineering/platform/issues/10928)) · Use getOwnAttributes for mixins when resolving required fields in process-resources ([#10936](https://github.com/hcengineering/platform/issues/10936)) · Backup restore ([#10943](https://github.com/hcengineering/platform/issues/10943)) · Office employee assign ([#10942](https://github.com/hcengineering/platform/issues/10942)) 
* ⚙️ MISCELLANEOUS TASKS: · Changelog ([#10834](https://github.com/hcengineering/platform/issues/10834)) · Push notifications button for desktop ([#10839](https://github.com/hcengineering/platform/issues/10839)) · Deprecated import endpoint ([#10912](https://github.com/hcengineering/platform/issues/10912)) · Shutdown announcement ([#10938](https://github.com/hcengineering/platform/issues/10938)) · Contact for questions ([#10939](https://github.com/hcengineering/platform/issues/10939)) · Link to missing file in backup-restore.en.md ([#10947](https://github.com/hcengineering/platform/issues/10947)) · Shutdown notice, since it is already included in the special build ([#10948](https://github.com/hcengineering/platform/issues/10948)) · Versions to 0.7.426 · Lock file · Package version 
* I18N: · *(pl)* Complete Polish translation for billing and contact plugins ([#10924](https://github.com/hcengineering/platform/issues/10924)) 

## [0.7.423] - 2026-05-10

* 🚀 FEATURES: · Print documents by class and id ([#10753](https://github.com/hcengineering/platform/issues/10753)) · Add tool to create missing SocialIdentity ([#10758](https://github.com/hcengineering/platform/issues/10758)) · User statuses ([#10774](https://github.com/hcengineering/platform/issues/10774)) · Add ability to configure guest spaces in settings ([#10770](https://github.com/hcengineering/platform/issues/10770)) · Add min and max transformation functions ([#10782](https://github.com/hcengineering/platform/issues/10782)) · Add trigger to remove associated execution data when a card is deleted ([#10795](https://github.com/hcengineering/platform/issues/10795)) · Add found elements count in desktop ([#10799](https://github.com/hcengineering/platform/issues/10799)) · Add StringFromEnum and EnumFromString process functions ([#10806](https://github.com/hcengineering/platform/issues/10806)) · Add left menu for styled text ([#10807](https://github.com/hcengineering/platform/issues/10807)) · Add show all versions toggle to card view options and implement version query filtering ([#10809](https://github.com/hcengineering/platform/issues/10809)) · To sort attributes for parent and sub class together ([#10816](https://github.com/hcengineering/platform/issues/10816)) · To copy controlled document content ([#10819](https://github.com/hcengineering/platform/issues/10819)) · Korean (ko) translation ([#10820](https://github.com/hcengineering/platform/issues/10820)) · Hide inactive employees ([#10821](https://github.com/hcengineering/platform/issues/10821)) · Array for relation ([#10827](https://github.com/hcengineering/platform/issues/10827)) 
* 🐛 BUG FIXES: · Apps customization ([#10755](https://github.com/hcengineering/platform/issues/10755)) · Grid migration ([#10762](https://github.com/hcengineering/platform/issues/10762)) · Card viewlet setting for associations ([#10761](https://github.com/hcengineering/platform/issues/10761)) · *(ci)* Emit TypeScript declarations before npm publish ([#10768](https://github.com/hcengineering/platform/issues/10768)) · Translation errors in copy table action ([#10769](https://github.com/hcengineering/platform/issues/10769)) · Calendar connection on small screens ([#10777](https://github.com/hcengineering/platform/issues/10777)) · Controlled document folder export ([#10775](https://github.com/hcengineering/platform/issues/10775)) · Tracker project actions ([#10786](https://github.com/hcengineering/platform/issues/10786)) · Training question actions ([#10780](https://github.com/hcengineering/platform/issues/10780)) · UI freeze on controlled doc update view ([#10778](https://github.com/hcengineering/platform/issues/10778)) · Auto join translations ([#10787](https://github.com/hcengineering/platform/issues/10787)) · Published packages ([#10788](https://github.com/hcengineering/platform/issues/10788)) · Re-enable model version check in CI ([#10796](https://github.com/hcengineering/platform/issues/10796)) · Login form layout on small screens ([#10798](https://github.com/hcengineering/platform/issues/10798)) · Allow to assign guest as space owner ([#10803](https://github.com/hcengineering/platform/issues/10803)) · Link action ([#10793](https://github.com/hcengineering/platform/issues/10793)) · Tables ([#10813](https://github.com/hcengineering/platform/issues/10813)) · Label overflow ([#10829](https://github.com/hcengineering/platform/issues/10829)) · Docker build ([#10831](https://github.com/hcengineering/platform/issues/10831)) · Set migration state in case of mode mismatch and add duration ([#10801](https://github.com/hcengineering/platform/issues/10801)) · Conflicta 
* ⚡ PERFORMANCE: · Memory usage for rekoni service ([#10797](https://github.com/hcengineering/platform/issues/10797)) 
* ⚙️ MISCELLANEOUS TASKS: · Changelog ([#10752](https://github.com/hcengineering/platform/issues/10752)) · Huly link ([#10754](https://github.com/hcengineering/platform/issues/10754)) · Auto-translate and mailbox ([#10800](https://github.com/hcengineering/platform/issues/10800)) · Version · Changelog 
